...
export function buildProfileFromFamily(
  ...
  return {
    ...
    city: firstString(family.city, onboardingPayload.city),
    state: firstString(family.state, onboardingPayload.state),
    cityNeighbourhood: firstString(family.village, family.locality, onboardingPayload.cityNeighbourhood),
...
export function buildListingFromFamily(
  ...
  return {
    ...
    propertyAddress: firstString(family.street_address, onboardingPayload.propertyAddress, meta.propertyAddress),
    ...
    houseRules: firstListString(family.house_rules, onboardingPayload.houseRules, onboardingPayload.houseRulesText, meta.houseRules),
