...
export const CHANNEL_PROVIDER_REGISTRY: ChannelProviderDefinition[] = [
  {
    ...
    description: "Prepare or refresh an existing Booking.com listing through Channex, then confirm room, rate, and sync readiness before go-live.",
    connectionMode: "Self-serve or assisted Booking.com connection through Channex",
  ...
  },
  {
    ...
    connectionMode: "Authorization and listing access via Airbnb / Channex",
    setupMode: "assisted",
    requiredSetupItems: [
  ...
  },
  {
    key: "agoda",
    displayName: "Agoda",
    description: "Agoda needs assisted channel-manager setup and mapping before the property can be activated.",
    connectionMode: "Assisted Agoda / YCS channel-manager setup",
    setupMode: "assisted",
    requiredSetupItems: [
      "Agoda Hotel ID",
  ...
  },
  {
    key: "expedia",
    displayName: "Expedia",
    description: "Expedia requires assisted property setup, mapping, and readiness checks before Famlo can activate it.",
    connectionMode: "Assisted Expedia partner / channel-manager setup",
    setupMode: "assisted",
    requiredSetupItems: [
      "Expedia Property ID",
