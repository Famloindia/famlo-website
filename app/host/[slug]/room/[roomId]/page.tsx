...
export default async function HostRoomPage({
  ...
  const roomFacts = [
    ...
    ...(room.toiletTypes.length > 0 ? [{ label: "Toilet type", value: room.toiletTypes.join(", ") }] : []),
                ...
                <RoomBookingPanel
                  home={{
                    ...
                    platformCommissionPct:
                      asNumber(resolved.familyRow?.platform_commission_pct ?? resolved.hostRow?.platform_commission_pct) ??
