...
export default async function TeamsPage({ searchParams }: TeamsPageProps) {
  ...
  if (activeTab === "vetting") {
    ...
    content = <SupportManager key={`${member.id}-open`} actorId={member.id} initialFilter="open" />;
  } else if (activeTab === "user-problems") {
    content = <SupportManager key={`${member.id}-user-problems`} actorId={member.id} initialFilter="user-problems" />;
