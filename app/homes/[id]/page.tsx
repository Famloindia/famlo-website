...
export default async function HomeDetailPage({
  ...
  const marketplaceAccess = canListOnMarketplace(
    {
  ...
  if (!isActive || !isAccepting || !marketplaceAccess.allowed) {
    notFound();
  }
  ...
  return (
    <main className="shell famlo-booking-page home-details-page" style={{ maxWidth: 1280, paddingTop: 20 }}>
      ...
      <RecentHomeViewTracker
        ...
        image={recentRoomImageUrl || home.imageUrls[0] || propertyMedia.gallery[0]?.url || ""}
      ...
      <div className={styles.homeDetailsGrid}>
        <div className={styles.homeMainColumn}>
          ...
          <div className={styles.homeMainContent}>
            ...
            {home.hostReels.length > 0 ? (
              <section style={{ background: "#fff", borderRadius: "24px", padding: "22px", border: "1px solid #eee", display: "grid", gap: "16px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "12px", flexWrap: "wrap" }}>
                  <div>
                    <h2 style={{ fontSize: "18px", fontWeight: 800, margin: 0, fontFamily: "'DM Sans', sans-serif" }}>{hostReelTitle}</h2>
                    <p style={{ margin: "6px 0 0", color: "#94a3b8", fontSize: "12px", fontWeight: 600 }}>
                      A quick vertical look at the home and the hosting experience.
                    </p>
                  </div>
                ...
                >
                  {home.hostReels.map((reel, index) => (
                    <div
                      key={reel.id || reel.publicUrl}
                      style={{
