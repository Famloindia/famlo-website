                ...
                <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: "16px" }}>
                  <thead>
                    <tr style={{ background: "#F1F5F9" }}>
                      <th style={{ padding: "12px", textAlign: "left", borderBottom: "2px solid #E2E8F0" }}>Model</th>
                      <th style={{ padding: "12px", textAlign: "left", borderBottom: "2px solid #E2E8F0" }}>Scope</th>
                      <th style={{ padding: "12px", textAlign: "left", borderBottom: "2px solid #E2E8F0" }}>Rate</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr><td style={{ padding: "12px", borderBottom: "1px solid #E2E8F0" }}>Flat commission</td><td style={{ padding: "12px", borderBottom: "1px solid #E2E8F0" }}>All marketplace bookings</td><td style={{ padding: "12px", borderBottom: "1px solid #E2E8F0" }}>16%</td></tr>
                  </tbody>
                </table>
