...
import { getHomepageData, getHomepageReelsData, type HomepageData } from "@/lib/discovery";
...
function withTimeoutFallback<T>(promise: Promise<T>, value: T, label: string, timeoutMs: number): Promise<T> {
