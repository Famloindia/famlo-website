...
import { buildPlatformAgreementCompatibilityPatch } from "@/lib/host-onboarding-legal";
...
export default function Step3Space({ data, update }: any) {
  ...
  const complete = Boolean(data.platformAgreementAccepted);
  ...
  const handleAgreementChange = (checked: boolean) => {
    ...
    const nextAcceptedAt =
      checked
        ? String(data.platformAgreementAcceptedAt || data.hostAgreementAcceptedAt || new Date().toISOString())
        : "";
    const compatibilityPatch = buildPlatformAgreementCompatibilityPatch(checked, nextAcceptedAt);
    for (const [key, value] of Object.entries(compatibilityPatch)) {
      update(key, value);
    }
  };
    ...
    <div className={styles.animateIn}>
      ...
      <div className={styles.formGrid}>
              ...
              return (
                <div key={doc.field} className={styles.docCard}>
                  <div className={styles.docCardTop}>
                    <div className={styles.docCardIntro}>
                  ...
                  <div className={styles.docActions}>
                    <div className={styles.docActionMeta}>
                      {value ? (
                    ...
                    <label className={styles.docUploadButton}>
                      <Upload size={14} />
                      {uploading === doc.field ? "Uploading..." : value ? "Change file" : "Upload file"}
                      <input
                        type="file"
        ...
        <section className={`${styles.formGroup} ${styles.fullWidth} ${styles.panelSection}`}>
          ...
          <div className={styles.choiceGrid}>
            ...
            <label className={styles.fullWidth}>
              ...
              />
              <div className={styles.helperText}>Required only if the host or business is registered under GST.</div>
            </label>
          </div>
        </section>
        ...
        <section className={`${styles.formGroup} ${styles.fullWidth} ${styles.panelSection}`}>
          <div className={styles.sectionHeading}>
            <div>
              <h2>Agreements</h2>
              <p>Review the platform agreement and accept it to finish your submission.</p>
            </div>
          ...
          <div className={styles.agreementList}>
            <label className={styles.agreementRow}>
              ...
              />
              <span>
                I have read and agree to the Famlo Platform Agreement, including host service terms, privacy/consent, commission/platform fee terms, code of conduct, and cancellation/penalty terms.
              </span>
              {complete ? <CheckCircle2 size={16} color="#059669" /> : null}
            </label>
          </div>
      ...
      {complete ? (
        <div className={styles.successBanner}>
          <ShieldCheck size={16} />
          Platform agreement accepted. You are ready to submit for review.
        </div>
      ) : null}
