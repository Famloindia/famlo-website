...
export default function FamloProDashboardShell({
  ...
  }, [activeSection, familyId, pathname, router, shouldAutoRefreshBookingFeed]);
  ...
  useEffect(() => {
    if (activeSection !== "inventory-calendar") return;
    let cancelled = false;
    const run = (): void => {
  ...
  }, [activeSection, familyId, calendarWindow.startDate, calendarWindow.endDate]);
  ...
  }, [activeSection, calendarWindow.endDate, calendarWindow.startDate, filteredCalendarRows, familyId]);
  useEffect(() => {
    if (activeSection !== "inventory-calendar") return;
  ...
  return (
    <div className={`${styles.shell} ${effectiveAppearanceIsLight ? styles.shellLight : ""} ${isDashboardWorkspace ? styles.dashboardWorkspaceShell : ""}`}>
      <ProDashboardMetricsBeacon metrics={dashboardLoadMetrics} />
      ...
      <main className={`${styles.main} ${isRevenueReportWorkspace ? styles.revenueReportMain : ""} ${isDashboardWorkspace ? styles.dashboardWorkspaceMain : ""}`}>
        ...
        <div className={`${styles.content} ${isPropertiesHomeView ? styles.propertiesHomeContent : ""} ${activeSection === "bookings" ? styles.bookingsWorkspaceContent : ""} ${isRevenueReportWorkspace ? styles.revenueReportContent : ""} ${isDashboardWorkspace ? styles.dashboardWorkspaceContent : ""}`}>
