...
Need help during your stay? Use the Famlo assistance path from your booking thread. If it is urgent, open the emergency support option in your booking dashboard and our team can help right away.`;
      ...
      const bookingResponse = await fetch("/api/bookings/create", {
        ...
        body: JSON.stringify({
          ...
          commissionPct: platformCommissionPct ?? 16,
          couponCode: null,
          vibe: "cultural",
  ...
  useEffect(() => {
    if (!resumeAfterProfileSaveRef.current || !profileUnlocked) {
      return;
    }
        ...
        <div style={{ padding: "18px" }}>
          <ProfileCompletionForm
            ...
            onSuccess={async () => {
              ...
              resumeAfterProfileSaveRef.current = true;
              setFeedback({
                type: "success",
